...
| `hold_duration` defaults to `'Intraday'` | [intraday/service.py:178](features/intraday/service.py#L178), [:285](features/intraday/service.py#L285) | Alert copy says "Square off before 3:10 PM" for a 5-day hold |
...
So a "win" may be a trade you were never filled on, and a "loss" may be one you'd never have entered. (The virtual portfolio is being dropped, but the same flaw must not be carried into swing tracking.)
